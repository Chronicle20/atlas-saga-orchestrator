...
func TestCommandSerialization(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: `{"characterId":12345,"type":"CREATE","body":{"templateId":1302000,"quantity":1}}`,
		...
		},
		{
			...
			expected: `{"characterId":12345,"type":"DELETE","body":{"templateId":1302000,"quantity":1}}`,
		...
		},
		{
			...
			expected: `{"characterId":12345,"type":"EQUIP","body":{"inventoryType":1,"source":5,"destination":-1}}`,
		...
		},
		{
			...
			expected: `{"characterId":12345,"type":"UNEQUIP","body":{"inventoryType":1,"source":-1,"destination":5}}`,
		...
		},
		{
			...
			expected: `{"characterId":12345,"type":"CREATE_AND_EQUIP","body":{"templateId":1302000,"quantity":1}}`,
